...
//		System.out.println("peek으로 꺼내온 값 : " + stack.peek());
		...
		System.out.println("stack의 isEmpty : " + stack.empty()); 	// 스텍안에 내용이 비어있냐? (true / false)
		 ...
		 * 			   peek() ==> 삭제없이 자료를 꺼내온다.
		 * 
		 * *** 스택은 Stack 클래스로 구현하여 제공하고 있지만, 큐는 Queue인터페이스로만
		 * 정의해 놓았을 뿐 별도의 클래스를 제공하고 있지 않다. 대신 Queue인터페이스를 구현한
