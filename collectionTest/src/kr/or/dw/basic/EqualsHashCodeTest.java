...
public class EqualsHashCodeTest {
	...
	public static void main(String[] args) {
		 ...
		 *   
		 * - hashCode() 메서드에서 사용하는 '해싱 알고리즘'은 서로다른 객체들에 대해서 같은
		 *   hashCode를 나타낼 수 있다.
		 */
...
//		p2.setName("홍길동");
		...
		System.out.println(p1 == p2);	// 참조값(번지)이 들어가는 거라서 false 주소값이 다름
		System.out.println(p1.equals(p2));	// equals()는 '==' 으로 비교한다. 위의 소스와 동일한 코드
...
class Person{
	...
	// equals에서 String이 같다고 나오는 이유는 재정의를 해놓았기 때문
